...
//        def lists = addApp("Lists", "Species lists", "http://lists.ala.org.au/ws")
        ...
        def biocache = addApp("Biocache", "Occurrence & Mapping services", "http://bioatlas.se/biocache-service")
        ...
        def layers = addApp("Layers", "Layer services including intersect","http://bioatlas.se/spatial/ws")
        def bie = addApp("BIE", "Species names and profiles", "http://bioatlas.se/bie/ws")
        def ecodata = addApp("Ecodata", "Occurrence & Mapping services", "http://bioatlas.se/ecodata")
        def lists = addApp("Lists", "Species lists", "http://bioatlas.se/lists/ws")
